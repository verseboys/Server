CKEDITOR.editorConfig = function (config) {
    ...
    config.toolbar = [
        // ['Undo', 'Redo', '-', 'Bold', 'Italic', 'Underline', '-', 'yikalink', '-', 'yikaimage']
            ['Undo', 'Redo','Maximize', '-', 'FontSize', '-', 'TextColor', 'BGColor', '-', 'Bold', 'Italic', 'Underline', '-', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock', '-',  'Subscript', 'Superscript', '-', 'Source','-','yikalink', '-', '-', 'yikaimage']
    ];
